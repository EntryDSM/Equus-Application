...
class PrintApplicationInfoGenerator(
    ...
    private fun insertCode(row: Row, applicationInfoVO: ApplicationInfoVO) {
        ...
        if (applicationInfoVO.applicationCase is GraduationCase) {
            ...
            row.createCell(15).setCellValue(applicationService.safeGetValue(qualificationCase.koreanGrade))
            row.createCell(16).setCellValue(applicationService.safeGetValue(qualificationCase.socialGrade))

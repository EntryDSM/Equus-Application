...
class PrintApplicationInfoGenerator(
    ...
    private fun insertCode(row: Row, applicationInfoVO: ApplicationInfoVO) {
        ...
        row.createCell(15).setCellValue(applicationService.safeGetValue(subject?.get("국어")?.get(3)))
        row.createCell(16).setCellValue(applicationService.safeGetValue(subject?.get("사회")?.get(3)))
        row.createCell(17).setCellValue(applicationService.safeGetValue(subject?.get("역사")?.get(3)))
        row.createCell(18).setCellValue(applicationService.safeGetValue(subject?.get("수학")?.get(3)))
        row.createCell(19).setCellValue(applicationService.safeGetValue(subject?.get("과학")?.get(3)))
        row.createCell(20).setCellValue(applicationService.safeGetValue(subject?.get("기술가정")?.get(3)))
        row.createCell(21).setCellValue(applicationService.safeGetValue(subject?.get("영어")?.get(3)))
        row.createCell(22).setCellValue(applicationService.safeGetValue(subject?.get("국어")?.get(2)))
        row.createCell(23).setCellValue(applicationService.safeGetValue(subject?.get("사회")?.get(2)))
        row.createCell(24).setCellValue(applicationService.safeGetValue(subject?.get("역사")?.get(2)))
        row.createCell(25).setCellValue(applicationService.safeGetValue(subject?.get("수학")?.get(2)))
        row.createCell(26).setCellValue(applicationService.safeGetValue(subject?.get("과학")?.get(2)))
        row.createCell(27).setCellValue(applicationService.safeGetValue(subject?.get("기술가정")?.get(2)))
        row.createCell(28).setCellValue(applicationService.safeGetValue(subject?.get("영어")?.get(2)))
        row.createCell(29).setCellValue(applicationService.safeGetValue(subject?.get("국어")?.get(1)))
        row.createCell(30).setCellValue(applicationService.safeGetValue(subject?.get("사회")?.get(1)))
        row.createCell(31).setCellValue(applicationService.safeGetValue(subject?.get("역사")?.get(1)))
        row.createCell(32).setCellValue(applicationService.safeGetValue(subject?.get("수학")?.get(1)))
        row.createCell(33).setCellValue(applicationService.safeGetValue(subject?.get("과학")?.get(1)))
        row.createCell(34).setCellValue(applicationService.safeGetValue(subject?.get("기술가정")?.get(1)))
        row.createCell(35).setCellValue(applicationService.safeGetValue(subject?.get("영어")?.get(1)))
        row.createCell(36).setCellValue(applicationService.safeGetValue(subject?.get("국어")?.get(0)))
        row.createCell(37).setCellValue(applicationService.safeGetValue(subject?.get("사회")?.get(0)))
        row.createCell(38).setCellValue(applicationService.safeGetValue(subject?.get("역사")?.get(0)))
        row.createCell(39).setCellValue(applicationService.safeGetValue(subject?.get("수학")?.get(0)))
        row.createCell(40).setCellValue(applicationService.safeGetValue(subject?.get("과학")?.get(0)))
        row.createCell(41).setCellValue(applicationService.safeGetValue(subject?.get("기술가정")?.get(0)))
        row.createCell(42).setCellValue(applicationService.safeGetValue(subject?.get("영어")?.get(0)))

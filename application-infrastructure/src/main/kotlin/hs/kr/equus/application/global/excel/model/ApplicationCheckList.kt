...
class ApplicationCheckList {
    ...
    fun formatSheet() {
        ...
        row7.createCell(2).setCellValue("조퇴")
        row7.createCell(3).setCellValue("결과")
        row7.createCell(4).setCellValue("출석점수")
        row7.createCell(5).setCellValue("봉사시간")
        row7.createCell(6).setCellValue("봉사점수")
